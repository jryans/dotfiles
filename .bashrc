...
# LLVM for Rust / WASM
alias llvm-wasm-build="cd ${PROJPATH}/llvm-project/build; "\
"cmake -G Ninja "\
...
# LLVM for JFS
alias llvm-jfs-build="cd ${PROJPATH}/llvm-project/build; "\
"cmake -G Ninja "\
"-D CMAKE_BUILD_TYPE=Release "\
...
# JFS
alias jfs-build="cd ${PROJPATH}/jfs/build; "\
"cmake -G Ninja "\
"-D CMAKE_BUILD_TYPE=Release "\
"-D LLVM_DIR=${PROJPATH}/llvm-project/build/lib/cmake/llvm "\
